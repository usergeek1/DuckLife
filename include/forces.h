...
/**
 * @brief Adds a force creator to a scene that acts like a buoyancy force  
 * 
 * @param scene 
 * @param G 
 * @param body1 
...
/**
 * @brief Create gravity force specifically for the duck that accounts for water level
 * 
 * @param scene 
 * @param G 
 * @param water_level 
