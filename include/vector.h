...
/**
 * @brief Returns the unit vector of the vector given
 *
 * @param point
 * @return vector_t
 */
...
/**
 * @brief Determines if two intervals overlap
 *
 * @param point1
 * @param point2
 * @return int
...
/**
 * @brief Returns the amount by which two verctors/intervals overlap
 *
 */
