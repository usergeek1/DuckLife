...
typedef enum scene_type scene_type_t;

/**
 * @brief Get the curr scene object
 *
 * @param scene
 * @return scene_type_t*
 */
scene_type_t *get_curr_scene(scene_t *scene);

/**
 * @brief Set the curr scene object
 *
 * @param scene
 * @param type
 * @return scene_type_t*
 */
scene_type_t *set_curr_scene(scene_t *scene, scene_type_t *type);
...
/**
 * @brief Given a body and scene, finds the index of the body in scene
 *
 */
int scene_get_index(scene_t *scene, body_t *body);

/**
 * @brief Removes last force from scene
 * 
 * @param scene 
 */
